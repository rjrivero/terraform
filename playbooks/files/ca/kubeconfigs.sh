...
export KUBERNETES_PUBLIC_ADDRESS=10.240.0.2

# Kubelet kubernetes config file
...
# Kube-controller-manager kubernetes config file
...
# Kube-scheduler kubernetes config file
